...
#define MCA_io_romio321_COMPLETE_CONFIGURE_FLAGS " FROM_OMPI=yes CC='gcc' CFLAGS='-O3 -DNDEBUG -finline-functions -fno-strict-aliasing -mcx16 -pthread -D__EXTENSIONS__' CPPFLAGS='    -I/usr/local/include -I/usr/local/include' FFLAGS='' LDFLAGS='   ' --enable-shared --disable-static  --prefix=/home/randywang/pathplanning/distributedplanning/openmpi-4.1.5/install --disable-aio --disable-weak-symbols --enable-strict --disable-f77 --disable-f90"
...
#define OPAL_PACKAGE_STRING "Open MPI randywang@randywang Distribution"
