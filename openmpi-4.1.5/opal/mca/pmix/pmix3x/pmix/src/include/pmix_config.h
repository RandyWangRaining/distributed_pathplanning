...
#define PACKAGE_STRING "pmix 3.2.4rc1"
...
#define PACKAGE_VERSION "3.2.4rc1"
...
#define PMIX_CONFIGURE_CLI " \'--disable-man-pages\' \'--disable-debug\' \'--with-pmix-symbol-rename=OPAL_MCA_PMIX3X_\' \'--enable-embedded-mode\' \'--disable-pmix-timing\' \'--without-tests-examples\' \'--disable-pmix-binaries\' \'--disable-pmix-backward-compatibility\' \'--disable-visibility\' \'--enable-embedded-libevent\' '--with-libevent-header=\"opal/mca/event/external/external.h\"' \'--enable-embedded-hwloc\' '--with-hwloc-header=\"opal/mca/hwloc/external/external.h\"' \'-prefix=/home/randywang/pathplanning/distributedplanning/openmpi-4.1.5/install/\' \'PKG_CONFIG_PATH=/opt/ros/noetic/lib/pkgconfig\' \'CFLAGS=-O3 -DNDEBUG  \' \'CPPFLAGS=-I/home/randywang/pathplanning/distributedplanning/openmpi-4.1.5 -I/home/randywang/pathplanning/distributedplanning/openmpi-4.1.5 -I/home/randywang/pathplanning/distributedplanning/openmpi-4.1.5/opal/include -I/home/randywang/pathplanning/distributedplanning/openmpi-4.1.5/opal/include    \' \'--cache-file=/dev/null\' \'--srcdir=.\' \'--disable-option-checking\'"

/* Date when PMIx was built */
#define PMIX_CONFIGURE_DATE "2023-12-08T16:27:40"

/* Hostname where PMIx was built */
#define PMIX_CONFIGURE_HOST "randywang"

/* User who built PMIx */
#define PMIX_CONFIGURE_USER "randywang"
...
#define PMIX_PACKAGE_STRING "PMIx randywang@randywang Distribution"
