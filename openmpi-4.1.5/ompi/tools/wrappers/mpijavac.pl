...
my $my_compiler = "";
my $mpi_jar   = "/home/randywang/pathplanning/distributedplanning/openmpi-4.1.5/install/lib/mpi.jar";
my $shmem_jar = "/home/randywang/pathplanning/distributedplanning/openmpi-4.1.5/install/lib/shmem.jar";
