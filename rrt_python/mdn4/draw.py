...
train_sets = torch.load( '../mdn/train_test_data/dataset_train'+str(wi)+'.pth')
test_sets = torch.load('../mdn/train_test_data/dataset_test'+str(wi)+'.pth')
unknown = torch.load('../mdn/train_test_data/train_sets_18001-20000.pkl')
print("加载成功")
...
def draw(m, data, wi ,w, pkl_num,t,model):
    ...
    weight_path = os.path.join('./model_2022-06-19_17-42-07.pth')
