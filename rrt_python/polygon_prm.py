...
class PRM(object):
    ...
    def List2obstacles(self,List):     #对其数据格式
        obstacles = []
    ...
    def all_edges_offlines(self):
        ...
        while(i < self.maxIter):
            ...
            if rand_poly_edge:
                self.edgeList.append(rand_poly_edge)
        i = 0
        self.xlim[0]=self.xlim[0]+10
        self.xlim[1]=self.xlim[1]+10
        self.ylim[0]=self.ylim[0]+10
